package com.spldeolin.satisficing.app.common.lock.aspect;
...
import com.spldeolin.satisficing.app.common.lock.annotation.StdLockM;
...
public class StdLockMAspect {
    ...
    @Pointcut("@annotation(com.spldeolin.satisficing.app.common.lock.annotation.StdLockM)")
    public void cut() {
    }
