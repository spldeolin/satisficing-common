package com.spldeolin.satisficing.app.common.enumcache;
...
import com.spldeolin.satisficing.api.common.EnumAncestor;
import com.spldeolin.satisficing.api.common.javabean.CodeAndTitle;
...
public class EnumCache implements InitializingBean {
    ...
    public void detectAndSaveToCache() {
        ...
        Reflections reflections = new Reflections(
                ...
                new ConfigurationBuilder().setUrls(ClasspathHelper.forPackage("com.spldeolin.satisficing"))
